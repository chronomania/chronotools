...
"än ","   Kyllä.","Melchior","Kansleri: ","ta ",
"uningatar","an ","en ","on ","in ",
NULL);
    num_restarts = dict.size();
    PreloadDict(dict, 
"      ","e ","ta","in","a ",": ","is",", ","en","t ","i ",
"an","ä ","ll","ka","er","it","tä","   ","va","on","et",
"as","o ","es","tu","te","ik","al","ol","us","ut","ha","ma",
"el","or","ti","ar","si","ou","mm","sa","os","än","un","ku","d ",
"ki","ko","y ","at","kä","ks","vä","th","to","ei","vi","vo","yt",
"a!","jo","s ","le","ai","om","ur","ni","of ","ää","Ozzie","ja",
